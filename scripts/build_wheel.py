...
def main(build_type: str = "Release",
    ...
    with working_directory(build_dir):
        ...
        build_run(
            f'cmake --build . --config {build_type} --parallel {job_count} --target tensorrt_llm tensorrt_llm_static manifold manifoldwrapper nvinfer_plugin_tensorrt_llm {th_common_lib}' # ToDo: Need to consider cpp_only option for manifold?????
